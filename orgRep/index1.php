...
<!-- Mirrored from html.designstream.co.in/pick/html/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Apr 2023 06:15:24 GMT -->
<head>
        <meta charset="UTF-8">
                    ...
                    <form action="signinLogic.php" method="post" class="row row-eq-height lockscreen  mt-5 mb-5">
                        ...
                        <div class="form-group mb-3" style="padding-bottom: 1rem; margin-top: 1rem;">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="pass" type="password" required="" id="password" minlength="8" maxlength="16" placeholder="Enter your password">
                            </div>
