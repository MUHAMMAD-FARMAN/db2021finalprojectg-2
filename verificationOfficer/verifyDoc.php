                    ...
                    <div class="d-sm-flex">
                        <div class="align-self-center">
                            <ul class="nav nav-pills flex-column flex-sm-row" id="myTab" role="tablist">
                                ...
                                <li class="nav-item ml-0">
                                    <a class="nav-link  py-2 px-3 px-lg-4 active" href="verifyDoc.php">Verify
                                        Document</a>
                                </li>
                                <li class="nav-item ml-0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group col-md-6" style="margin-top:20px">
                                        <label for="inputState">Search Document</label>
                                        <select id="inputState" class="form-control">
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                    ...
                                    <button class="btn btn-primary" type="submit" style="margin-left:17px">View
                                        Document</button>

                                    <button class="btn btn-primary" type="submit"
                                        style="margin-left:17px">Verify</button>
                                </form>
